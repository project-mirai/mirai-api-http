...
* **[API文档参考](docs/API.md)**
  ...
  * [消息发送与撤回](docs/API.md#消息发送与撤回)
    ...
    * [发送图片消息（通过URL）](docs/API.md#发送图片消息（通过URL）)
  ...
  * [接收消息与事件](docs/API.md#接收消息与事件)
    ...
    * [通过WebSocket](docs/API.md#通过WebSocket)
      * [接收消息](docs/API.md#接收消息)
      * [接收事件](docs/API.md#接收事件)
      * [同时接收事件与消息](docs/API.md#同时接收事件与消息)
  * [好友与群(成员)列表](docs/API.md#好友与群(成员)列表)
  ...
  * [群管理](docs/API.md#群管理)
    ...
    * [查询群文件列表](docs/API.md#查询群文件列表)
    * [获取群文件详细信息](docs/API.md#获取群文件详细信息)
  ...
  * [插件与Console](docs/API.md#插件与Console)
    ...
    * [获取Mangers](docs/API.md#获取Managers)
