 ...
 * 上传图片
 */
internal suspend fun onUploadImage(session: HttpAuthedSession, stream: InputStream, type: String): UploadImageRetDTO {
...
internal suspend fun onUploadVoice(session: HttpAuthedSession, stream: InputStream, type: String): UploadVoiceRetDTO {
